...
public class ReduceBolt implements IRichBolt {
    ...
    public void prepare(Map<String,String> stormConf, 
        ...
        WorkerServer.bdb.addReduceBoltDb(executorId);
       // if (!stormConf.containsKey("reduceClass"))
		...
		neededVotesToComplete = totalMapBoltPerWorker * (WorkerHelper.getWorkers(stormConf).length - 1)* totalReduceBoltPerWorker + totalMapBoltPerWorker;
    ...
    public synchronized void execute(Tuple input) {
    	if (sentEof) {
			...
			{
				HashMap<String, ArrayList<String>> groups = WorkerServer.bdb.getAllGroup(executorId);
	        ...
	        WorkerServer.bdb.addValue(executorId, key, value);
