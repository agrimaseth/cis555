...
public class DistributedCluster implements Runnable {
	...
	public TopologyContext submitTopology(String name, Config config, Topology topo,String workerDir) throws ClassNotFoundException {
		theTopology = name;
		
		//added, if does not exist create
